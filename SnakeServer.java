...
public class SnakeServer extends Frame
{
...
//				String str2 = "Client said:" + dis.readUTF() + "just now.";
				String str2 = "Client said:";
				while(str != null && str.length() !=0)
				{
					System.out.println(str);
//					dos.writeUTF(str2);
					dos.writeUTF(str2+str);
...
//					send(str);
	...
	{
		SnakeServer cs = new SnakeServer(8888);
		cs.startServer();
	}
}
